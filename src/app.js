...
app.use(cors({ origin: true, methods: ['GET', 'POST', 'DELETE', 'OPTIONS'], allowedHeaders: ['Content-Type', 'Authorization', 'X-Service-Token'] }));
...
// Local file serving (dev). Production: use object storage CDN.
